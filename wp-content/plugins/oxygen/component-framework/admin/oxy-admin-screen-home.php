<div class='wrap oxygen-admin-screen-home'>
	...
	?>
		<div class='oxygen-admin-screen-home-section-design-set-chooser'>
			...
			<?php if($site) { ?>
			<div class='oxygen-admin-screen-home-section-design-set-chooser-text'>The <?php echo esc_html($site);?> pre-built website has been installed from the Oxygen Design Library.</div>
			<?php } ?>
