		...
		foreach($ct_source_sites as $key => $site) {
			...
			<div class='oxygen-vsb-design-set-install-wizard-design-sets-design-set'>
				...
				<div class='oxygen-vsb-design-set-install-wizard-design-sets-design-set-info'>
					...
					<a href='<?php echo esc_url($site);?>' target='_blank'>View Demo</a>
				</div>
				<a href='' data-site='<?php echo esc_attr($key);?>' class='oxygen-vsb-design-set-install-wizard-button oxygen-vsb-design-set-install-button'>Install</a>
			</div>
