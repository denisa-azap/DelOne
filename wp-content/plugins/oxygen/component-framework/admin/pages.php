...
function oxygen_vsb_register_settings() {
   ...
   register_setting( 'oxygen_vsb_options_group', 'oxygen_vsb_disable_google_fonts' );
      ...
      <?php do_settings_sections( 'oxygen_vsb_options_group' ); ?>
		  <table>
			  <tr valign="top" style='display: none;'>
				  ...
				  <td><textarea id="oxygen_vsb_source_sites" name="oxygen_vsb_source_sites"><?php echo esc_textarea(get_option('oxygen_vsb_source_sites')); ?></textarea></td>
			  </tr>
			  <tr valign="top">
			  ...
			  <tr valign="top">
				  <th scope="row"><label for="oxygen_vsb_disable_google_fonts"><?php _e("Force Disable Google Fonts","oxygen"); ?></label></th>
