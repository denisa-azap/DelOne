...
function ct_get_base() {
	...
	if($installedSet) {
		...
		ob_start();?>
			...
			<div class="oxygen-add-section-subsection" ng-click="iframeScope.openLoadFolder('<?php echo esc_attr($installedSet) ;?>-0', '<?php echo esc_attr($installedSet) ;?>', true, $event)">
				<img src="<?php echo CT_FW_URI; ?>/toolbar/UI/oxygen-icons/add-icons/small-generic.svg" class="oxygen-add-section-subsection-icon">
				<?php echo esc_html($installedSet) ;?>									<img src="<?php echo CT_FW_URI; ?>/toolbar/UI/oxygen-icons/add-icons/small-arrow.svg">
			</div>
...
function ct_get_page_settings($only_template=false) {
	...
	// use to save page settings generated once to prevent multiple DB calls
	global $oxygen_vsb_page_settings_cache;

	if ($oxygen_vsb_page_settings_cache) {
		return $oxygen_vsb_page_settings_cache;
	}
	...
	if ($only_template) {
		...
		$oxygen_vsb_page_settings_cache = $template_settings;
	...
	$oxygen_vsb_page_settings_cache = $settings;
	return $settings;
}
