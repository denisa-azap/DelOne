...
class Oxygen_VSB_Pricing_Box extends CT_Component{
    ...
    function generate_css($params=false, $class=false, $defaults=array()) {
        ...
        ob_start(); ?>
            ...
            <?php $css .= $this->get_single_css_property("background-color", oxygen_vsb_get_global_color_value($params['pricing_box_graphic_background'])); ?>
            ...
            <?php $css .= $this->get_single_css_property("background-color", oxygen_vsb_get_global_color_value($params['pricing_box_title_background'])); ?>
            <?php if ($css!="") : ?>
            ...
            <?php $css .= $this->get_single_css_property("background-color", oxygen_vsb_get_global_color_value($params['pricing_box_price_background'])); ?>
            ...
            <?php $css .= $this->get_single_css_property("background-color", oxygen_vsb_get_global_color_value($params['pricing_box_content_background'])); ?>
            ...
            <?php $css .= $this->get_single_css_property("background-color", oxygen_vsb_get_global_color_value($params['pricing_box_cta_background'])); ?>
