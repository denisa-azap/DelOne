...
Class CT_Text_Block extends CT_Component {
	...
	function add_shortcode( $atts, $content, $name ) {
		...
		?><<?php echo esc_attr($options['tag'])?> id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>"><?php echo $content; ?></<?php echo esc_attr($options['tag'])?>><?php
