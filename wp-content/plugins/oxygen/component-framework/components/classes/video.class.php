	...
	function add_shortcode( $atts, $content = null, $name = null ) {
        ...
        <?php
        	if($options['use_custom'] !== '1') {
        		$src = do_shortcode($options['src']);
        ?>
        <div class="oxygen-vsb-responsive-video-wrapper"><iframe src="<?php echo $this->getYoutubeVimeoEmbedUrl($src); ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
        <?php
        	}
        	else {
        ?>
